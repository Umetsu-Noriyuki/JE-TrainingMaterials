...
「どのコマンドを使うか」  
を整理した表です。
| 事故内容 | commit前 | commit済( push前 ) | push済 | 章 |
|---|---|---|---|---|
| pull conflict<br>merge conflict<br>PR conflict | 変更取り込みconflict<br>　fetch, pull | merge時conflictを解消<br>　merge | conflictを解消<br>　revert | 4章 |
| 誤branch作業<br>誤branch commit | branch移動<br>　switch | branch間commit取り込み<br>　switch, cherry-pick | push済commitを取り消す<br>　revert | 5章 |
| message修正<br>add漏れ<br>不要commit | - | 直前commitを修正<br>　amend | push済commitを取り消す<br>　revert | 6章 |
| commit戻したい<br>履歴整理したい | - | local履歴を戻す<br>　reset | push済commitを取り消す<br>　revert | 7章 |
| reset戻しすぎ<br>消えたcommit復旧 | - | 操作履歴から復旧<br>　reflog, reset | - | 8章 |
| commit取り込み<br>別branchへ適用 | - | commitを別branchへ適用<br>　cherry-pick | commitを別branchへ適用<br>　cherry-pick | 9章 |
| 作業一時退避<br>別branch確認 | 作業内容を一時退避<br>　stash | 作業内容を一時退避<br>　stash | - | S0101参照 |
...
[[ このページの先頭に戻る ]](#) [[ メニューに戻る ]](README.md#1-2)
